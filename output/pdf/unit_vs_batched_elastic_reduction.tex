...
\title{Unit-Step versus Batched Elastic Reduction\\
...
elastic-reduction algorithm are \emph{not} identical algorithms: even in exact
...
\begin{figure}[htbp]
 \centering
 \includegraphics[width=0.68\textwidth]{../../Plots/elastic_reduction_near_center_counterexample.png}
