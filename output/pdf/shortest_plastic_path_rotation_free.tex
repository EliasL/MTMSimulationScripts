...
\title{Why a Shortest Plastic-Reduction Path\\
...
\begin{abstract}
The unit-shear plastic reduction searches words in four integer simple
...
Equation~\eqref{eq:elasticdomain}.  A \emph{globally shortest plastic-reduction word}
...
\begin{theorem}[No rotational segment in a shortest plastic-reduction word]
...
\begin{corollary}
A globally shortest plastic-reduction word also contains no nonempty contiguous
...
The missing logical step is now supplied: the shortest plastic-reduction
...
the shear generators would construct a strictly shorter plastic-reduction path.
