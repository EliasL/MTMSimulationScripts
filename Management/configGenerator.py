...
class SimulationConfig:
    ...
    def __init__(self, configPath=None, **kwargs):
        ...
        self.reconnectEdgeLocking = 0  # Edge locking is opt-in.
        ...
        self.energyFunction = "contiSquare"  # "contiSquare", "contiTriangular"
        ...
        # - LBFGS
        self.LBFGSNrCorrections = 7  # nr correction vector pairs
        self.LBFGSScale = 1.0
    ...
    def generate_name(self, withExtension=True):
        name = (
            ...
            + f"{'' if self.reconnectionMethod == 'none' else self.reconnectionMethod}"
            + f"t{self.nrThreads}"
        )
