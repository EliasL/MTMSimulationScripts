...
def I2(c11, c22, c12):
    return (1.0 / 4.0) * ((c11 - c22) ** 2) + (1.0 / 12.0) * ((c11 + c22 - 4 * c12) ** 2)

def I3(c11, c22, c12):
    return ((c11 - c22) ** 2) * (c11 + c22 - 4 * c12) - (1.0 / 9.0) * ((c11 + c22 - 4 * c12) ** 3)

def psi1(I1, I2, I3):
    return (I1 ** 4 * I2) - (41.0 * I2 ** 3 / 99.0 ) + (7 * I1 * I2 * I3 / 66.0) + (I3 ** 2 / 1056.0)

def psi2(I1, I2, I3):
    return (4.0 * I2 ** 3 / 11.0) + (I1 ** 3 * I3) - (8.0 * I1 * I2 * I3 / 11.0) + (17.0 * I3 ** 2 / 528.0)
...
ccode_derivaties = [f"double var{i} = {ccode(expr)};" for i, expr in enumerate(simplified_formulas)]
